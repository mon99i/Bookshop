...
INSERT INTO books (title, img, category_id, form, isbn, summary, detail, author, pages, contents, price, pub_date)
VALUES ("혹부리 영감", 22, 2, "ebook", 10, "노래 주머니..", "혹 두개 되버림..", "김영감", 100, "목차입니다.", 20000, "2024-05-27");


SELECT * FROM books LEFT
JOIN category ON books.category_id = category.id;

SELECT  FROM books LEFT JOIN category ON books.category_id = category.id WHEREbooks.id=1;
